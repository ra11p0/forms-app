...
function DateField(props) {
    ...
    return (_jsxs(_Fragment, { children: [(props.forbidFuture || props.forbidPast) &&
                _jsx(Form.Text, { children: fieldInfo }), _jsx(ReactDatePicker, { selected: new Date(value), readOnly: props.forbidFuture && props.forbidPast, maxDate: props.forbidFuture ? now : null, minDate: props.forbidPast ? now : null, onChange: (newValue) => {
