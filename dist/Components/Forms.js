...
function Forms(props) {
    ...
    return (_jsx(Provider, Object.assign({ store: store }, { children: _jsx("div", Object.assign({ className: "w-50" }, { children: _jsx(Loading, Object.assign({ isReady: true }, { children: _jsxs(_Fragment, { children: [props.mode == ApplicationModes.Edit &&
